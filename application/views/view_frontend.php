...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <!-- <h1 class="logo me-auto"><a href="<?php echo base_url(); ?>">  dsdsd </a></h1> -->
      <!-- Uncomment below if you prefer to use an image logo -->
      <a href="index.html" class="logo me-auto me-lg-12"><img src="<?php echo base_url('assets/frontend/'); ?>img/logocf.png" alt="" class="img-fluid"></a>
